...
import { useState, useRef, useEffect, useLayoutEffect, forwardRef, useCallback, useContext, useMemo } from 'react';
...
function SpringNumber(props) {
    ...
    return (jsx(AnimatedSpan, { className: className, style: style, children: springProps.number.to(x => x.toFixed(0)) }));
}
...
function AnimatedTitle(props) {
  ...
  `, []);
    return (jsx("div", { className: containerClassName, style: containerStyle, children: jsx("div", { className: titleClass, children: title }) }));
}
...
const Button = ({ variant, ...props }) => {
  ...
  `, []);
    ...
    return (jsx("button", { ...props, className: className, style: styles(), children: props.children }));
};

export { AnimatedTitle, Button, SpringNumber };
